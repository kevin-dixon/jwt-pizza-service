...
franchiseRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    logger.log("info", "franchise", "franchise created", {
...
franchiseRouter.delete(
  ...
  asyncHandler(async (req, res) => {
    ...
    logger.log("warn", "franchise", "franchise deleted", {
      franchiseId,
      adminId: req.user?.id,
    });
...
franchiseRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    logger.log("info", "franchise", "store created", {
      storeId: store.id,
...
franchiseRouter.delete(
  ...
  asyncHandler(async (req, res) => {
    ...
    logger.log("warn", "franchise", "store deleted", {
      storeId,
      franchiseId,
      userId: req.user.id,
    });
